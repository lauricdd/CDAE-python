...
from recommenders.recommender import ItemSimilarityRecommender
...
"""
    ...
    # print data  # ==> File containing simply formatted row,col,val sparse matrix data.
    ...
    # # if we want we can compute these individually without calling I tensorflow/core/platform/cpu_feature_guard.cc:142] Your CPU supports instructions that this TensorFlow binary was not compiled to use: AVX2 FMA()
